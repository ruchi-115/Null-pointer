...
// //         setData(json);
// //       } catch (err) {
// //         console.error('Failed to fetch MNR data:', err);
// //       }
// //     };
...
// //       <h1>MNR Realtime Data</h1>
// //       {data ? (
// //         <pre style={{ backgroundColor: '#f5f5f5', padding: '10px', fontSize: '0.9rem' }}>
// //           {JSON.stringify(data, null, 2)}
// //         </pre>
// //       ) : (
// //         <p>Loading MNR data...</p>
// //       )}
// //     </main>
// //   );
// // }
...
//   return (
//     <main className="p-6">
//       <h1 className="text-2xl font-bold mb-4">Metro-North Railroad Real-Time Schedules and Status</h1>
...
//                         <th className="px-3 py-2 border-b border-gray-200">Stop ID</th>
//                         <th className="px-3 py-2 border-b border-gray-200">Arrival Time</th>
//                         <th className="px-3 py-2 border-b border-gray-200">Arrival Delay</th>
//                         <th className="px-3 py-2 border-b border-gray-200">Departure Time</th>
//                         <th className="px-3 py-2 border-b border-gray-200">Departure Delay</th>
//                       </tr>
//                     </thead>
//                     <tbody>
//                       {stops.map((stop, idx) => {
    ...
    return (
      <main className="p-6">
        <h1 className="text-2xl font-bold mb-4">
          Metro-North Railroad Real-Time Schedules and Status
        </h1>
        <p>Loading data...</p>
      </main>
    );
